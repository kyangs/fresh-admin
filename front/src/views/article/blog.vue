  ...
  <div class="app-container">
    ...
    <div v-if="showSearch" class="filter-container">
      <el-form :inline="true" :model="listQuery" class="form-inline">
        <el-form-item label="">
          <el-input size="mini" v-model="listQuery.title" placeholder="标题" clearable  />
        </el-form-item>
        <el-form-item label="">
          <el-input size="mini" v-model="listQuery.cate_id" placeholder="分类" clearable  />
        </el-form-item>
        <el-form-item label="">
          <el-input size="mini" v-model="listQuery.column_id" placeholder="栏目" clearable  />
        </el-form-item>
        <el-form-item label="">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="160px" class-name="small-padding" fixed="right">
        <template slot-scope="scope">
